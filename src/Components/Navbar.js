    ...
    <div className="nav">
        ...
        <label htmlFor="bmenub" className="hide-menu">&times;</label>
            ...
            <DropDown className="services-menu" title="services" isOpen={this.state.servicesisOpen} change={this.services} >
                <a href="Production"className="pseudo icon-picture">Video Production</a>
                <a href="Entertainment" className="pseudo icon-picture">BIRTHDAYS</a>
                <a href="Entertainment" className="pseudo icon-picture">EVENTS</a>
                <a href="LiveShows" className="pseudo icon-picture">Live Shows</a>
                <a href="Entertainment"className="pseudo icon-picture">Summer Camp</a>
            </DropDown>
            ...
            <a href="contact" className="new contact-link pseudo icon-picture">contact</a>
